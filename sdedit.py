...
def run_sdedit(
    ...
    # c_edited：从整段视频 latent 取第 0 帧（已含标记），再在 latent 空间
    # 强制叠加标记信号——VAE 8× 压缩使 4px 标记退化，latent 注入确保信号可感知
